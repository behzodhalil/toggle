...
public fun ToggleContext.getStringAttribute(key: String, default: String? = null): String? {
    return (attributes[key] as? AttributeValue.StringValue)?.value ?: default
}


public fun ToggleContext.getBooleanAttribute(key: String, default: Boolean = false): Boolean {
    return (attributes[key] as? AttributeValue.BooleanValue)?.value ?: default
}

public fun ToggleContext.getIntAttribute(key: String, default: Int? = null): Int? {
    return (attributes[key] as? AttributeValue.IntValue)?.value ?: default
}

public fun ToggleContext.getDoubleAttribute(key: String, default: Double? = null): Double? {
    return (attributes[key] as? AttributeValue.DoubleValue)?.value ?: default
}


public fun ToggleContext.getLongAttribute(key: String, default: Long? = null): Long? {
    return (attributes[key] as? AttributeValue.LongValue)?.value ?: default
}

public fun ToggleContext.getShortAttribute(key: String, default: Short? = null): Short? {
